...
class JusterB:
    ...
    def insure(self, user, amount, pool):
        ...
        availability = 1 - self.lock_shares / self.total_shares
        available_from = self.pools[ pool_from ] * availability
        available_to = self.pools[ pool_to ] * availability
    ...
    def withdraw_lock(self, lock_id):
        ...
        # TODO: need to have a test to differentiate
