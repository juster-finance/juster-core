...
class JusterB:
    ...
    def provide_liquidity(self, user, amount):
        deposit = Deposit(
            ...
            unclaimed_profits=self.unclaimed_profits,
    ...
    def insure(self, user, amount, pool):
        ...
        liquidity_multiplier = (self.total_liquidity + self.unclaimed_profits) / self.total_liquidity
        ratio = self.pools.get(pool_from) / (self.pools.get(pool_to) + amount*liquidity_multiplier)
        delta = ratio * amount
